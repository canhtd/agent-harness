  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M5 5.5v5M11 5v5.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M5 5.5c0 2 2 3.5 6 3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none" />
      </svg>
    ),
  },
  {
