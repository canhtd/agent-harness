            ...
            <table className="w-full text-sm">
              ...
              <tfoot>
                <tr className="border-t border-black/10 font-semibold">
                  ...
                  <td className="px-4 py-3 text-right tabular-nums">
                    {formatTokens(totalsRow.input_tokens)}
                  </td>
                  <td className="px-4 py-3 text-right tabular-nums">
                    {formatTokens(totalsRow.output_tokens)}
                  </td>
                  <td className="px-4 py-3 text-right tabular-nums">
                    {formatTokens(totalsRow.cache_read_tokens)}
                  </td>
                  <td className="px-4 py-3 text-right tabular-nums">
                    <span
                      style={{
                        color: costColor(totalsRow.estimated_cost_usd),
                      }}
                    >
